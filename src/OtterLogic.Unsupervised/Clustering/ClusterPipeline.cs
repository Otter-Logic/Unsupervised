...
public static class ClusterPipeline
{
    ...
    /// <param name="options">Pipeline settings; <see cref="ClusterPipelineOptions.Groups"/> is ignored.</param>
    ...
    public static IReadOnlyList<GroupCountCandidate> ChooseGroupCount(
        double[,] data, ClusterPipelineOptions options, int minimumGroups = 2, int maximumGroups = 10)
    {
        ArgumentNullException.ThrowIfNull(data);
        ArgumentNullException.ThrowIfNull(options);
